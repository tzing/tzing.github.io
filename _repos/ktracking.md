...
image: assets/repos/ktracking.png
description: Implementation of "Kernel-based object tracking" (Comaniciu et al.)
create: 2017-06-20
tags:
  - Computer Vision
  - Python
github: tzing/ktracking
lang: zh_TW
use_math: true
---
...
- [bag](https://youtu.be/HxoUzaFtkKk)
  ...
  <div class="ui embed" data-source="youtube" data-id="HxoUzaFtkKk"></div>

- [bolt](https://youtu.be/MwQ_3OiYptw)

  <div class="ui embed" data-source="youtube" data-id="MwQ_3OiYptw"></div>

- [bmx](https://youtu.be/cNQuw8qwuvw)

  <div class="ui embed" data-source="youtube" data-id="cNQuw8qwuvw"></div>

- [fernando](https://youtu.be/kt6j9sjPQSY)

  <div class="ui embed" data-source="youtube" data-id="kt6j9sjPQSY"></div>
...
{% include img.html src="https://github.com/tzing/ktracking/raw/master/report/img/output_12_0.png" %}
...
{% include img.html src="https://github.com/tzing/ktracking/raw/master/report/img/output_18_0.png" %}
...
{% include img.html src="https://github.com/tzing/ktracking/raw/master/report/img/output_7_0.png" %}

透過以上操作可以計算出位移量 (-18, -2)
{% include img.html src="https://github.com/tzing/ktracking/raw/master/report/img/output_28_0.png" %}
...
[run.ipynb]: https://nbviewer.jupyter.org/github/tzing/ktracking/blob/master/src/run.ipynb
[detail.ipynb]: https://nbviewer.jupyter.org/github/tzing/ktracking/blob/master/src/detail.ipynb
